...
- [Google项目](#google项目)
  - [google sys](#google-sys)
    - [设置git代理](#设置git代理)
  - [整体编译](#整体编译)
  - [单独编译u-boot和kernel](#单独编译u-boot和kernel)
  - [GoogleHome 地址](#googlehome-地址)
    - [uboot](#uboot)
    - [kernel](#kernel)
...
- https://eureka-partner-review.googlesource.com/q/owner:shengken.lin%2540amlogic.corp-partner.google.com

- https://partnerissuetracker.corp.google.com/issues?q=status:open%20componentid:1037236&s=created_time:desc
